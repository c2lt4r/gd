...
/// GDScript keywords.
const KEYWORDS: &[&str] = &[
    "func", "var", "const", "signal", "class", "extends", "if", "elif", "else", "for", "while",
    "match", "return", "break", "continue", "pass", "await", "yield", "self", "super", "true",
    "false", "null", "void", "preload", "load", "export", "onready", "static", "class_name",
    "tool", "enum",
];

/// GDScript built-in types.
const BUILTIN_TYPES: &[&str] = &[
    "int", "float", "bool", "String", "Vector2", "Vector3", "Vector4", "Vector2i", "Vector3i",
    "Vector4i", "Array", "Dictionary", "NodePath", "StringName", "Color", "Rect2", "Transform2D",
    "Transform3D", "Basis", "AABB", "Plane", "Quaternion", "PackedByteArray", "PackedInt32Array",
...
const BUILTIN_FUNCTIONS: &[&str] = &[
    "print", "prints", "printt", "printerr", "push_error", "push_warning", "str", "int", "float",
    "bool", "len", "range", "typeof", "is_instance_of", "abs", "sign", "min", "max", "clamp",
    "lerp", "smoothstep", "sqrt", "pow", "sin", "cos", "tan", "floor", "ceil", "round", "randi",
    "randf", "randomize", "seed", "hash", "is_equal_approx", "is_zero_approx",
];
