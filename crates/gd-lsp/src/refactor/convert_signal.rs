...
pub fn convert_signal(
    ...
    let relative_scene = gd_core::fs::relative_slash(scene_file, project_root);
...
fn convert_to_code(
    ...
    let scene_data = gd_core::scene::parse_scene(&scene_source)?;
    ...
    let relative_script = gd_core::fs::relative_slash(&script_path, project_root);
