...
pub fn inline_variable(
    ...
    let scope_node = if is_local {
        crate::references::enclosing_function(root, point)
    ...
    if !dry_run {
        ...
        let tree2 = gd_core::parser::parse(&new_source)?;
        ...
        let decl2 = if is_local {
            crate::references::enclosing_function(root2, point)
...
fn find_var_declaration<'a>(
    ...
    if let Some(func) = crate::references::enclosing_function(root, position)
